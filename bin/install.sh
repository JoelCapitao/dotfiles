...
# Originally from: https://github.com/jessfraz/dotfiles/blob/master/bin/install.sh 
# Modified slightly.
...
setup_sources() {
	...
	#kcat <<-EOF > /etc/apt/sources.list.d/google-cloud-sdk.list
	#kdeb http://packages.cloud.google.com/apt $CLOUD_SDK_REPO main
	#kEOF
...
get_dotfiles() {
	...
	if [[ ! -d "${HOME}/dotfiles" ]]; then
		...
		git clone git@github.com:JoelCapitao/dotfiles.git "${HOME}/dotfiles"
	fi
